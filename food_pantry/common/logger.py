...
## Dejo sólo un "_" para que sea accesible desde las clases hijas.
## Si se quiere usar el logger en una clase hija, se debe llamar al método init_log
## Dos "__" es para que no se pueda acceder desde las clases hijas.
